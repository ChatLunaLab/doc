...
> [!TIP] 快速开始
> - 如果你使用的模型支持图像输入，请在“工具与多模态”小节中开启 `image` 的选项。
> - 如果你决定使用工具调用预设，请在“工具调用回复”小节中开启 `experimentalToolCallReply` 选项。
> - “全局私聊”/“全局群聊”/“分群聊配置”/“分私聊配置”互相独立，请根据需要分别配置。
> 
> **如果你不打算深入研究原理或大幅度改写预设，可以忽视下面的所有内容。**
